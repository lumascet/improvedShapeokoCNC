...
constexpr cfgItem_t sys_config_items_2[] = {
    ...
    { "sys","mfoe",_bin, 0, cm_print_froe, cm_get_froe,cm_get_froe,nullptr, FEED_OVERRIDE_ENABLE},
    { "sys","mfo", _fin, 3, cm_print_fro,  cm_get_fro, cm_set_fro, nullptr, FEED_OVERRIDE_FACTOR},
